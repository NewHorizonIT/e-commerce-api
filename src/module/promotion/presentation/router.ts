...
export function createPromotionRouter(controller: PromotionController): Router {
    ...
    router.delete('/admin/promotions/:id/variant/:variantId', authenticate, validateRequest({ params: removeDetailParamSchema }), controller.deletePromotionDetail.bind(controller));
    return router;
}